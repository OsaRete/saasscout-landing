...
function stringField(value: unknown, max: number) { if (value === undefined || value === null) return undefined; if (typeof value !== "string") failInvalid(); const normalized = value.trim().slice(0, max); return normalized || undefined; }
