...
test("problem synthesis collapse diagnostics are exposed through orchestrator metrics", () => {
      ...
      problemIntelligenceSynthesis: {
        ...
        diagnostics: [{
          candidateCollapseReport: {
            ...
            rankedSeeds: [{ title: "Specific workflow problem", normalizedTitle: "specific workflow problem", market: "agencies", audience: "operators", problemCluster: "workflow", score: 8.7, rejectionReasons: [], engineSupport: ["pain", "opportunity"], evidenceCount: 3, genericTitle: false, downrankedGeneric: false }],
  ...
  assert.deepEqual(metrics.problem_synthesis, {
    ...
    ranked_seeds: [{ title: "Specific workflow problem", normalizedTitle: "specific workflow problem", market: "agencies", audience: "operators", problemCluster: "workflow", score: 8.7, rejectionReasons: [], engineSupport: ["pain", "opportunity"], evidenceCount: 3, genericTitle: false, downrankedGeneric: false }],
