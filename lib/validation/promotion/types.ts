...
export type ResolutionIdentity = { provenanceCanonicalProblemId?: string | null; subjectLabel?: string | null; hypothesisProblemClaim?: string | null; respondentProse?: string | null };
export type CanonicalResolutionResult = { status: "resolved" | "unmatched" | "ambiguous" | "insufficient_identity"; canonicalProblemId: string | null; resolverRuleVersion: typeof VALIDATION_CANONICAL_RESOLVER_VERSION; reason: "provenance_id_match" | "exact_normalized_canonical_title" | "exact_normalized_alias" | "canonical_identity_ambiguous" | "canonical_identity_unmatched" | "explicit_problem_identity_missing"; identitySource: "provenance" | "subject_label" | "hypothesis_problem_claim" | null };
